...
| views.unhealthyConfigs.excludedTypes[0] | string | `"MissionControl::Application"` |  |
| views.unhealthyConfigs.excludedTypes[10] | string | `"MissionControl::Scope"` |  |
| views.unhealthyConfigs.excludedTypes[11] | string | `"MissionControl::Team"` |  |
| views.unhealthyConfigs.excludedTypes[12] | string | `"MissionControl::View"` |  |
| views.unhealthyConfigs.excludedTypes[1] | string | `"MissionControl::Canary"` |  |
| views.unhealthyConfigs.excludedTypes[2] | string | `"MissionControl::Connection"` |  |
| views.unhealthyConfigs.excludedTypes[3] | string | `"MissionControl::IncidentRule"` |  |
| views.unhealthyConfigs.excludedTypes[4] | string | `"MissionControl::Notification"` |  |
| views.unhealthyConfigs.excludedTypes[5] | string | `"MissionControl::NotificationSilence"` |  |
| views.unhealthyConfigs.excludedTypes[6] | string | `"MissionControl::Permission"` |  |
| views.unhealthyConfigs.excludedTypes[7] | string | `"MissionControl::PermissionGroup"` |  |
| views.unhealthyConfigs.excludedTypes[8] | string | `"MissionControl::Playbook"` |  |
| views.unhealthyConfigs.excludedTypes[9] | string | `"MissionControl::ScrapeConfig"` |  |
